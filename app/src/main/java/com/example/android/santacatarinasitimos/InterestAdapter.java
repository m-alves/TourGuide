...
public class InterestAdapter extends ArrayAdapter<Interest> {
    ...
    /** Resource ID for the background color for this list of Interests */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       /* // Set the theme color for the list item
        ...
        // Return the whole list item layout (containing severral TextViews) so that it can be shown in
        // the ListView.
        return listItemView;
    }
}
